 ...
 *       &lt;sequence>
 *         &lt;element name="TaxCurrencyCode" type="{urn:un:unece:uncefact:data:standard:QualifiedDataType:103}CurrencyCodeType" minOccurs="0"/>
 *         &lt;element name="OrderCurrencyCode" type="{urn:un:unece:uncefact:data:standard:QualifiedDataType:103}CurrencyCodeType"/>
 *         &lt;element name="InvoiceCurrencyCode" type="{urn:un:unece:uncefact:data:standard:QualifiedDataType:103}CurrencyCodeType" minOccurs="0"/>
 *         &lt;element name="InvoicerTradeParty" type="{urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:103}TradePartyType" minOccurs="0"/>
 *         &lt;element name="InvoiceeTradeParty" type="{urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:103}TradePartyType" minOccurs="0"/>
 *         &lt;element name="SpecifiedTradeSettlementPaymentMeans" type="{urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:103}TradeSettlementPaymentMeansType" minOccurs="0"/>
 *         &lt;element name="ApplicableTradeTax" type="{urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:103}TradeTaxType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="SpecifiedLogisticsServiceCharge" type="{urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:103}LogisticsServiceChargeType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="SpecifiedTradePaymentTerms" type="{urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:103}TradePaymentTermsType" minOccurs="0"/>
