 ...
 *         &lt;element name="ModelID" type="{urn:un:unece:uncefact:data:standard:UnqualifiedDataType:128}IDType" minOccurs="0"/>
 ...
 *         &lt;element name="BrandName" type="{urn:un:unece:uncefact:data:standard:UnqualifiedDataType:128}TextType" minOccurs="0"/>
 *         &lt;element name="ModelName" type="{urn:un:unece:uncefact:data:standard:UnqualifiedDataType:128}TextType" minOccurs="0"/>
 *         &lt;element name="ApplicableProductCharacteristic" type="{urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:128}ProductCharacteristicType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="DesignatedProductClassification" type="{urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:128}ProductClassificationType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="IndividualTradeProductInstance" type="{urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:128}TradeProductInstanceType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="ApplicableSupplyChainPackaging" type="{urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:128}SupplyChainPackagingType" minOccurs="0"/>
 *         &lt;element name="OriginTradeCountry" type="{urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:128}TradeCountryType" minOccurs="0"/>
 *         &lt;element name="AdditionalReferenceReferencedDocument" type="{urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:128}ReferencedDocumentType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="IncludedReferencedProduct" type="{urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:128}ReferencedProductType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
