 ...
 *         &lt;element name="MinimumQuantity" type="{urn:un:unece:uncefact:data:standard:UnqualifiedDataType:103}QuantityType" minOccurs="0"/>
 *         &lt;element name="MaximumQuantity" type="{urn:un:unece:uncefact:data:standard:UnqualifiedDataType:103}QuantityType" minOccurs="0"/>
 *         &lt;element name="AppliedTradeAllowanceCharge" type="{urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:103}TradeAllowanceChargeType" minOccurs="0"/>
 *         &lt;element name="IncludedTradeTax" type="{urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:103}TradeTaxType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
